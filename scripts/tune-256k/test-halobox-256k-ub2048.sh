#!/usr/bin/env bash
# 256k Context validation with -ub 2048 on halo-box master (5f851647f)
set -u
...
LOG="$OUT/halobox-256k-ub2048.log"
...
echo "=== Running 256k context probe with -ub 2048 on halo-box (5f851647f) ==="
export RADV_PERFTEST=unified_heap
export GGML_VK_MAX_MB_PER_SUBMIT=2048

# Initialize log with banner to avoid empty log watchdog
echo "=== Running 256k -ub 2048 probe ===" > "$LOG"
...
echo "=== 256k -ub 2048 probe finished ==="
